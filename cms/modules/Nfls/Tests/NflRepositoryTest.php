...
use App\Repositories\Nfl\NflRepository;
use Illuminate\Foundation\Testing\DatabaseMigrations;

class NflRepositoryTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->repo = $this->app->make(NflRepository::class);
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Repositories\Nfl\Nfl');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->assertDatabaseHas('nfls', $this->editedArray);
    }
