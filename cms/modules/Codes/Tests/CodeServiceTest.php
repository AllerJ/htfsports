...
class CodeServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(CodeService::class);
        $this->originalArray = [];
        $this->editedArray = [];
        $this->searchTerm = '';
    }
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Repositories\Code\Code');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->assertDatabaseHas('codes', $this->editedArray);
    }
