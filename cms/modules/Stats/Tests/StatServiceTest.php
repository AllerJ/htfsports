...
class StatServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(StatService::class);
        $this->originalArray = [];
        $this->editedArray = [];
        $this->searchTerm = '';
    }
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Repositories\Stat\Stat');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->assertDatabaseHas('stats', $this->editedArray);
    }
