...
class PlayerRepositoryTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->repo = $this->app->make(PlayerRepository::class);
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Repositories\Player\Player');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->assertDatabaseHas('players', $this->editedArray);
    }
