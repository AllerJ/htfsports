...
class RosterServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(RosterService::class);
        $this->originalArray = [];
        $this->editedArray = [];
        $this->searchTerm = '';
    }
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Repositories\Roster\Roster');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->assertDatabaseHas('rosters', $this->editedArray);
    }
