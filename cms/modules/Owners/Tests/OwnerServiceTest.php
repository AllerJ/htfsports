...
class OwnerServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(OwnerService::class);
        $this->originalArray = [];
        $this->editedArray = [];
        $this->searchTerm = '';
    }
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Repositories\Owner\Owner');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->assertDatabaseHas('owners', $this->editedArray);
    }
