...
class GameRepositoryTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->repo = $this->app->make(GameRepository::class);
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Repositories\Game\Game');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->assertDatabaseHas('games', $this->editedArray);
    }
