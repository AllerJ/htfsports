...
class VenueServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(VenueService::class);
        $this->originalArray = [];
        $this->editedArray = [];
        $this->searchTerm = '';
    }
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Repositories\Venue\Venue');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->assertDatabaseHas('venues', $this->editedArray);
    }
